...
int main(int argc, char *argv[]){
  ...
  r = (double*) _mm_malloc(Nbody * sizeof(double), 16);
  delta_r = (double*) _mm_malloc(Nbody*Nbody*sizeof(double), 16);
  
  mass = (double*) _mm_malloc(Nbody*sizeof(double), 16);
  radius = (double*) _mm_malloc(Nbody*sizeof(double), 16);
  vis = (double*) _mm_malloc(Nbody*sizeof(double), 16);


  // f = (double**) _mm_malloc(Ndim*sizeof(double*), 16);
  // pos = (double**) _mm_malloc(Ndim*sizeof(double*), 16);
  // velo = (double**) _mm_malloc(Ndim*sizeof(double*), 16);
  // delta_pos = (double**) _mm_malloc(Ndim*sizeof(double*), 16); 
  // for(i = 0; i < Ndim; i++){
  //   f[i] = (double*) _mm_malloc(Nbody*sizeof(double), 16);
  //   pos[i] = (double*) _mm_malloc(Nbody*sizeof(double), 16);
  //   velo[i] = (double*) _mm_malloc(Nbody*sizeof(double), 16);
  //   delta_pos[i] = (double*) _mm_malloc(Nbody*Nbody*sizeof(double), 16); 
  // }
  f[0] = (double*) _mm_malloc(Ndim*Nbody*sizeof(double), 16);
  pos[0] = (double*) _mm_malloc(Ndim*Nbody*sizeof(double), 16);
  velo[0] = (double*) _mm_malloc(Ndim*Nbody*sizeof(double), 16);
  delta_pos[0] = (double*) _mm_malloc(Ndim*Nbody*Nbody*sizeof(double), 16);
